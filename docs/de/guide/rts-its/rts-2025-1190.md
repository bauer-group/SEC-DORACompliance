...
BAUER GROUP ist nicht TLPT-pflichtig, muss aber **an TLPT-Tests von Kunden mitwirken und kooperieren** (Art. 26 Abs. 4). Eine TLPT-Kooperationsklausel sollte in allen Verträgen mit systemrelevanten Finanzunternehmen enthalten sein.
